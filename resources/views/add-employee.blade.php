            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-underline" id="modalTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="payrollSetup-tab" data-bs-toggle="tab"
                                data-bs-target="#payrollSetup" type="button" role="tab"
                                aria-controls="payrollSetup" aria-selected="false">
                                Payroll Setup
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="leaveQuota-tab" data-bs-toggle="tab"
                                data-bs-target="#leaveQuota" type="button" role="tab" aria-controls="leaveQuota"
                                aria-selected="false">
                                Leave Quota
                            </button>
                        </li>
                    ...
                    <div class="tab-content mt-3" id="modalTabsContent">
                                    ...
                                    <form action="">
                                        <div class="row g-3">
                                            <div class="col-12 col-lg-6">
                                                <label for="tb_name" class="form-label">Name&nbsp;<span
                        ...
                        <!-- Payroll Setup -->
                        <div class="tab-pane fade" id="payrollSetup" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <form action="">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 col-lg-4">
                                                <label for="tb_numberOfDays" class="form-label">Number Of
